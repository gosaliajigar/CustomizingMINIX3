...
static void myannounce(void)
{
  /* Display Custom MINIX startup banner. */
  printf("\n\n\n");
  printf("=============================================================\n");
  printf("        WELCOME TO MINIX OPEN SOURCE OPERATING SYSTEM        \n");
  printf("=============================================================\n");
  printf("  COURSE NAME    : PRINCIPLES OF OS & DISTRIBUTED SYSTEMS    \n");
  printf("  COURSE NUMBER  : CSC 502                                   \n");
  printf("  PROFESSOR NAME : DR. YURONG XU                             \n");
  printf("  STUDENT NAME   : JIGAR GOSALIA                             \n");
  printf("  STUDENT ID     : 89753                                     \n");
  printf("=============================================================\n");
  printf("\n\n\n");
}
